...
#define DEFAULT_SLEEP_MIN_FREQ 245000
#define DEFAULT_SLEEP_PREV_FREQ 245000 //This is so that if there are any issues resulting in sleep_prev_freq getting set, there will be a backup freq
